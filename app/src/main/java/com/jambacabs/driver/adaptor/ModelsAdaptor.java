...
public class ModelsAdaptor extends ArrayAdapter<JSONObject>
{
    private Context context;
    private List<JSONObject> arr_list_data;
    private CustomTextView textView;

    public ModelsAdaptor(Context context, int resource, ArrayList<JSONObject> arr_list_data, CustomTextView textView)
    {
