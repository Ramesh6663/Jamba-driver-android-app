...
public class MapAnimator {
    ...
    static final int GREY = Color.parseColor("#9B9898");
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> points) {
        ...
        optionsBackground.addAll(points);
        optionsBackground.jointType(ROUND);
        ...
        optionsForeground = new PolylineOptions();
        optionsForeground.addAll(points);
        optionsForeground.jointType(ROUND);
        ...
        ObjectAnimator foregroundRouteAnimator = ObjectAnimator
                .ofObject(this, "routeIncreaseForward", new RouteEvaluator(), points.toArray());
